document.addEventListener('DOMContentLoaded', function () {
  ...
  const ANIMATION_DELAY_ATTR = 'data-animation-delay';

  function initScrollAnimations() {
    const animatableElements = document.querySelectorAll(
      '.animate-on-scroll, [data-animate], .feature-card, .pricing-card, .testimonial-card, .team-card, .service-card, .section-header, .hero-content'
    );
    ...
    animatableElements.forEach(function (el, index) {
      ...
      if (!el.hasAttribute(ANIMATION_DELAY_ATTR)) {
        ...
        if (siblingIndex > 0) {
          el.setAttribute(ANIMATION_DELAY_ATTR, siblingIndex * 100);
        }
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Bis of Love משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1570d6b2-e89d-4107-8d20-58bf7945a893',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1570d6b2-e89d-4107-8d20-58bf7945a893';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1570d6b2-e89d-4107-8d20-58bf7945a893';
